...
@author: shifangzhou & CharlesHe & Andy
'''
import numpy as np
import h5py
import random
...
beginMode = "validation"


# This module is for forward feeding batch_normalization, with 'training' and 'testing' mode
...
# This module is used by the L2 regularization: weight decay
...
if __name__ == "__main__":
    ...
    if beginMode == "predict":
        with h5py.File('test_128.h5','r') as H:
            test = np.copy(H['test'])
            network.train(data, label, 0.0001, 20, 32, 0.9, 0.999, [0.2, 0.5], 0.00001, 1e-5)
